...
class transferEnv_(gym.Env):
  metadata={'render.modes':  []}

  def __init__(self,transferClassObject,record_name="record_"+datetime.datetime.now().strftime("%m_%d_%Y_%H_%M_%S")+".csv"):####runType=0 for non-RL run runType=!0 for RL run
